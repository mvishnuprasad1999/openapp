...
//   const PerticularProfileShowScreen({
//     super.key,
...
//                     // MY POSTS BUTTON
//                     Text(
//                       "My Posts (${user.posts?.length ?? 0})",
//                       style: const TextStyle(color: Colors.white),
//                     ),

//                     const SizedBox(height: 20),

//                     // FIELDS (UNCHANGED UI STYLE)
//                     Expanded(
...
//                             _field("Profile Title", user.profileTitle),
//                             const SizedBox(height: 20),
//                             const Text(
//                               "About",
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => UserPostsScreen(userId: userId),
                            ),
                          );
                        },
                        child: Container(
